...
# Android appearance copy.
p = "app/src/main/java/app/turp/chat/ui/SettingsScreen.kt"
repl(
    p,
...
repl(
    ...
    "Arbor palette description",
)

# Pages theme engine. The original green base remains Arbor; Turp overrides it.
p = "docs/assets/js/theme-boot.js"
slot = "    turp: { dark: {}, light: {} },\n    graphite:"
repl(
    p,
    slot,
    """    turp: {
...
p = "docs/assets/css/appearance.css"
repl(
    p,
    "  --preview-primary: #99d5b1;\n  --preview-secondary: #b5ccbc;\n  --preview-tertiary: #a5cddd;",
    "  --preview-primary: #ffb1c5;\n  --preview-secondary: #b5ccb6;\n  --preview-tertiary: #d8c68b;",
    "Turp swatch",
)
repl(
    p,
    ".palette-choice[data-scheme-choice='graphite'] {",
    ".palette-choice[data-scheme-choice='turp'] {\n  --preview-primary: #ffb1c5;\n  --preview-secondary: #b5ccb6;\n  --preview-tertiary: #d8c68b;\n}\n\n.palette-choice[data-scheme-choice='arbor'] {\n  --preview-primary: #99d5b1;\n  --preview-secondary: #b5ccbc;\n  --preview-tertiary: #a5cddd;\n}\n\n.palette-choice[data-scheme-choice='graphite'] {",
    "Arbor swatch",
)

p = "docs/assets/js/i18n.js"
repl(
    p,
...
Path("app/src/test/java/app/turp/chat/ui/ThemePaletteRegressionTest.kt").write_text(
