...
import app.xylune.chat.ui.theme.resolvedDarkMode

/**
 * Palette-aware launcher handoff and splash surface.
 *
 * This process remains independent from MainActivity, so it can reopen Xylune
...
open class LauncherActivity : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val colors = resolvedXyluneColorScheme(this, palette, themeMode, amoled)
...
class LauncherXyluneActivity : LauncherActivity()
