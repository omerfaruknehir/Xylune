...
private const val PORTABLE_SETTINGS_SCHEMA = "turp-portable-settings-v1"
...
class AppSettingsArchiveStore(
    ...
    private fun restorePreferences(
        ...
        preferences.setPalette(value.palette.enumOr(ColorPalette.TURP))
    ...
    private companion object {
        const val LINUX_PREFERENCES = "turp_linux_runtime"
