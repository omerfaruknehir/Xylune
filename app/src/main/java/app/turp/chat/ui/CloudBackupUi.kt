...
import app.turp.chat.transfer.GoogleDriveAuthorizationFailure
import app.turp.chat.transfer.GoogleDriveAuthorizationFailureKind
import app.turp.chat.transfer.describeGoogleDriveAuthorizationFailure
        ...
        AlertDialog(
            ...
            confirmButton = {
                Button(onClick = {
                    deleteTarget = null
                    when (entry.provider) {
                        app.turp.chat.transfer.CloudBackupProvider.SCOPED_FOLDER -> scope.launch {
                        ...
                        app.turp.chat.transfer.CloudBackupProvider.GOOGLE_DRIVE_APP_DATA ->
