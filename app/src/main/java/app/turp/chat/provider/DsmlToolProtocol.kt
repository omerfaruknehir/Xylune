 ...
 * decoded arguments through Turp's normal native-tool validation and execution.
 */
 ...
 * with a correction prompt first; Turp executes this parsed form only if that retry also fails.
 */
