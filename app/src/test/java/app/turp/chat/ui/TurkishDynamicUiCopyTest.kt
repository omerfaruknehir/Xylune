...
class TurkishDynamicUiCopyTest {
    ...
    fun `update status keeps repository values but translates surrounding copy`() {
        assertEquals(
            "Güncellemeler omerfaruknehir/Turp üzerinden kontrol edilir.",
            TurkishDynamicUiCopy.translate("Updates are checked against omerfaruknehir/Turp."),
        )
        assertEquals(
            "omerfaruknehir/Turp kontrol ediliyor…",
            TurkishDynamicUiCopy.translate("Checking omerfaruknehir/Turp…"),
        )
        assertEquals("Turp 0.24.27 kullanılabilir", TurkishDynamicUiCopy.translate("Turp 0.24.27 is available"))
        assertEquals("Kaynak: omerfaruknehir/Turp", TurkishDynamicUiCopy.translate("Source: omerfaruknehir/Turp"))
    }
