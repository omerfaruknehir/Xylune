...
- Ayarlar sayfa başlıklarının işlem/sistem yerel ayarı yerine Xylune'da seçilen uygulama dilini izlemesi sağlandı.
- Arama ve web yönlendirme, sağlayıcının yerel araması, Xylune arama motorları, kimlik bilgileri ve ilgili açıklamalar için Türkçe kapsamı genişletildi.
