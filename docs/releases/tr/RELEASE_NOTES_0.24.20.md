...
- Kaynak çipleri ileti düzeninde sabit kalırken ayrı bir katman, çipin gerçek sınırlarından kaynak önizlemesine dönüşerek açılıyor.
- Hafif, bir öğeye bağlı menülerde normal dışarı dokunarak kapatma davranışı geri getirildi.
