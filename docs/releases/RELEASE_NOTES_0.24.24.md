...
- Fixed Settings route titles so they follow Turp's selected app language rather than relying on the process/system locale.
- Expanded Turkish coverage for Search & web routing, native-provider search, Turp search engines, credentials, and related descriptions.
